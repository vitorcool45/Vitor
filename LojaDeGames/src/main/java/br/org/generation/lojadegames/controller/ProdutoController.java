...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>> getByEmpresa(@PathVariable String empresa){
		return ResponseEntity.ok(produtoRepository.findAllByEmpresaContainingIgnoreCase(empresa));
	}
